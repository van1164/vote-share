...
class VoteRepository : BaseRepository() {
    ...
    fun loadVoteDetailByVoteUrl(voteUrl: String): VoteDetailDTO {
        val jpql = "select new com.van1164.voteshare.dto.VoteDetailDTO(v.title,v.subTitle,v.publicShare,v.maxSelectItem,v.allVoteSum,v.updatedDate,v.mainImageUrl,v.voteUrl) from Vote v where v.voteUrl =: voteUrl"
    ...
    fun loadVoteListByUserId(id: Long): MutableList<VoteDetailDTO> {
        val jpql = "select new com.van1164.voteshare.dto.VoteDetailDTO(v.title,v.subTitle,v.publicShare,v.maxSelectItem,v.allVoteSum,v.updatedDate,v.mainImageUrl,v.voteUrl) from Vote v join v.user u where u.id =: userId"
